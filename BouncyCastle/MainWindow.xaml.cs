...
namespace BouncyCastle
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            RsaBase64Key keyPair = RsaKeyPairGenerator();
            string plaintext = "Hello, this is a test message!";
            string encryptedText = EncryptionByPublicKey(plaintext, keyPair.PublicKey);
            string decryptedText = DecryptByPrivateKey(encryptedText, keyPair.PrivateKey);
        }

        public struct RsaBase64Key
        {
